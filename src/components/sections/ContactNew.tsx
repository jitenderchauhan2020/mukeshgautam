              ...
              <div className="space-y-6 bg-gradient-to-br from-gray-50 to-gray-100 p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <div className="pt-4 border-t border-gray-300">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {/* WhatsApp */}
                    <a 
                      href="https://wa.me/919619582408"
                      className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors group touch-manipulation"
                      target="_blank"
