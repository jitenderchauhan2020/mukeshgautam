            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <a 
                  ...
                  className="w-8 h-8 bg-[#113F67]/10 rounded-lg flex items-center justify-center hover:bg-green-500/20 transition-all duration-300 group"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                >
                  <svg className="w-4 h-4 text-[#113F67] group-hover:text-green-600 transition-colors" fill="currentColor" viewBox="0 0 24 24">
